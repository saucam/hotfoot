...
object DATE extends NativeColumnType(DateType, 8, 4) {
  override def extract(buffer: ByteBuffer): Int = {
    buffer.getInt
  }
...
object TIMESTAMP extends NativeColumnType(TimestampType, 9, 8) {
  override def extract(buffer: ByteBuffer): Long = {
    buffer.getLong
  }
...
case class FIXED_DECIMAL(precision: Int, scale: Int)
...
object FIXED_DECIMAL {
  val defaultSize = 8
}

private[hotfoot] sealed abstract class ByteArrayColumnType[T <: DataType](
                                                                           typeId: Int,
                                                                           defaultSize: Int)
...
object BINARY extends ByteArrayColumnType[BinaryType.type](11, 16) {
...
// byte array.
object GENERIC extends ByteArrayColumnType[DataType](12, 16) {
  override def setField(row: MutableRow, ordinal: Int, value: Array[Byte]): Unit = {
